...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 w-full bg-white shadow-md px-4 sm:px-6 md:px-8">
      <nav className="max-w-[1760px] mx-auto flex items-center justify-between h-[60px] my-6">
        {/* Logo */}
        ...
        <div className="hidden lg:flex flex-1 items-center justify-evenly ml-36">
          {/* Nav Links */}
          <div className="flex gap-4 xl:gap-12 2xl:gap-24 text-[16px] xl:text-[18px] font-normal">
            <a href="/" className="hover:text-[#3DBEC8]">Home</a>
            <a href="/service" className="hover:text-[#3DBEC8]">Service</a>
            <a href="/about" className="hover:text-[#3DBEC8]">About Us</a>
            <a href="/contact" className="hover:text-[#3DBEC8]">Contact Us</a>
          </div>
        ...
        {/* Right Section (Avatar + Hamburger) - Always Visible */}
          ...
          <div className="relative">
            ...
            >
              <div className="rounded-full h-[36px] w-[36px] md:h-[40px] md:w-[40px] overflow-hidden">
                <img src="/header/user.png" alt="Profile" className="object-cover w-full h-full" />
              </div>
              <svg
